         ...
         <table class="header_table">
            <tbody>
               <xsl:for-each select="n1:componentOf/n1:encompassingEncounter">
                  ...
                  <tr>
                     <td width="20%" bgcolor="#3399ff">
                        <span class="td_label_ins">
                           <xsl:text>Date of visit/Admission/discharge (Encounter Date)</xsl:text>
                        </span>
                     </td>
                     <td colspan="3">
                  ...
                  <xsl:if test="n1:location/n1:healthCareFacility">
                     <tr>
                        <td width="20%" bgcolor="#3399ff">
                           <span class="td_label_ins">
                              <xsl:text>Visit/Encounter Location</xsl:text>
                           </span>
                        </td>
                        <td colspan="3">
                           <xsl:choose>
                  ...
                  <xsl:if test="n1:responsibleParty">
                     <tr>
                        <td width="20%" bgcolor="#3399ff">
                           <span class="td_label_ins">
                              <xsl:text>Provider's name (Responsible party)</xsl:text>
                           </span>
                        </td>
                        <td>
                           <xsl:call-template name="show-assignedEntity">
            ...
            <tbody>
               <xsl:for-each select="n1:documentationOf">
                  ...
                  <xsl:for-each select="n1:serviceEvent/n1:performer">
                     ...
                     <tr>
                        <td width="20%" bgcolor="#3399ff">
                           <span class="td_label_ins">Care team: 
                              <xsl:call-template name="firstCharCaseUp">
                                 <xsl:with-param name="data" select="$displayName"/>
                              </xsl:call-template>
                           </span>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <xsl:choose>
                              <xsl:when test="n1:patient/n1:raceCode">
                                 <xsl:for-each select="n1:patient/n1:raceCode">
                                    <xsl:call-template name="show-race-code"/>
                                 </xsl:for-each>
                              </xsl:when>
                              <xsl:otherwise>
                                 <span class="redtext">
                                 <xsl:text>Code not available</xsl:text>
                                 </span>   
                              </xsl:otherwise>
                           </xsl:choose>
                           </span>
...
-->
   <xsl:template name="section">
      ...
      <xsl:call-template name="sectioncode"/>
      <xsl:for-each select="n1:component/n1:section">
   ...
   <!-- Alex's added CODE Section -->
      <xsl:template name="sectioncode">
         <br></br>   
         <table>
               <tr>
                  <td>
               ...
               <tr>
                  <td>
                     <xsl:if test="n1:templateId">                     
                        <xsl:choose>        
                                <xsl:when test="n1:templateId">
                                   <xsl:for-each select="n1:templateId">
                                      <xsl:call-template name="show-section-code"/>
                                   </xsl:for-each>
                                </xsl:when>
                             <xsl:otherwise>
                                 <span class="redtext">TEMPLATE ID MISSING - NO CODES WILL BE SHOWN</span>
                             </xsl:otherwise>
                         </xsl:choose> 
                     </xsl:if>   
                  </td>
   ...
   <!-- Alex's added CODE sub Section 1 --> 
   <xsl:template name="show-section-code">
       <xsl:choose>
          <!-- Med allergies -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.6.1&apos;">           
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '48765-2']">
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:participant/n1:participantRole/n1:playingEntity/n1:code">
                 CodeSystemName:<span class="greentext"> <xsl:value-of select="@codeSystemName"/> </span>
                 CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                 Code: <span class="greentext"> <xsl:value-of select="@code"/> </span>
                 Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>
                 <br></br>            
             </xsl:for-each>                        
             </xsl:for-each>
          </xsl:when>
          <!-- Meds -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.1.1&apos;">
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '10160-0']"> 
             <xsl:for-each select="n1:entry/n1:substanceAdministration/n1:consumable/n1:manufacturedProduct/n1:manufacturedMaterial/n1:code">
                CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                CodeSystem:<span class="greentext"> <xsl:value-of select="@codeSystem"/> </span>
                Code: <span class="greentext"> <xsl:value-of select="@code"/> </span>
                Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>
          ...
          <!-- Meds administered-->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.38&apos;">
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '29549-3']"> 
                <xsl:for-each select="n1:entry/n1:substanceAdministration/n1:consumable/n1:manufacturedProduct/n1:manufacturedMaterial/n1:code">
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"> <xsl:value-of select="@codeSystem"/> </span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/> </span>
          ...
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.17&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '29762-2']"> 
               <xsl:for-each select="n1:entry/n1:observation">
                CodeSystemName:<span class="greentext"><xsl:value-of select="n1:value/@codeSystemName"/></span>
                CodeSystem:<span class="greentext"><xsl:value-of select="n1:value/@codeSystem"/></span>
                Code: <span class="greentext"> <xsl:value-of select="n1:value/@code"/> </span>
                Name: <span class="greentext"> <xsl:value-of select="n1:value/@displayName"/> </span>
                <br></br>
               </xsl:for-each>
             </xsl:for-each>                     
          </xsl:when>
          <!-- Problems -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.5.1&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.5&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '11450-4']">                
                 <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                    CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                    CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                    Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                    Name: <span class="greentext"> <xsl:value-of select="@displayName"/></span>                
          ...
          <!-- Lab test results -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.3.1&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '30954-2']">                
                <xsl:for-each select="n1:entry/n1:organizer/n1:component/n1:observation">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="n1:code/@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="n1:code/@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="n1:code/@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="n1:code/@displayName"/> </span>
                   PQ-Value: <span class="greentext"> <xsl:value-of select="n1:value/@value"/> </span>
                   PQ-Unit: <span class="greentext"> <xsl:value-of select="n1:value/@unit"/> </span>
                   ST-Value: <span class="greentext"> <xsl:value-of select="n1:value"/> </span>                   
                   <br></br>
                </xsl:for-each><br></br>
                Labs only:<br></br>
          ...
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.43&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '46241-6']">                
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
          ...
          <!-- Vitals -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.4.1&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.4&apos;)">      
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '8716-3']">                
                <xsl:for-each select="n1:entry/n1:organizer/n1:component/n1:observation">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="n1:code/@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="n1:code/@codeSystem"/></span>                
                   Code: <span class="greentext"> <xsl:value-of select="n1:code/@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="n1:code/@displayName"/> </span>                                                            
                   Value:<span class="greentext"><xsl:value-of select="n1:value/@value"/></span>
                   Unit:<span class="greentext"><xsl:value-of select="n1:value/@unit"/></span>              
                   <br></br>      
                </xsl:for-each>
                <br></br>
             </xsl:for-each>
          ...
          <!-- Reason for referral -->
          <xsl:when test="@root = &apos;1.3.6.1.4.1.19376.1.5.3.1.3.1&apos;">        
             <span class="greentext">
                Coded values are not inspected for this section
             </span>
          </xsl:when>
          <!-- Advance Directives -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.21&apos;">        
             <span class="greentext">
                Coded values are not inspected for this section
             </span>
          </xsl:when>       
          ...
          <!-- Procedures -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.7.1&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '47519-4']">                
                <xsl:for-each select="n1:entry/n1:observation/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
                ...
                <xsl:for-each select="n1:entry/n1:procedure/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
                  ...
                  <xsl:for-each select="n1:entry/n1:act/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <!-- Immunizations -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.2.1&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '11369-6']">                
                <xsl:for-each select="n1:entry/n1:substanceAdministration/n1:consumable/n1:manufacturedProduct/n1:manufacturedMaterial/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
          ...
          <!-- Hospital Discharge instructions / Clinical instructions -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.41&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.45&apos;)">        
             <span class="greentext">
                Coded values are not inspected for this section
             </span>
          </xsl:when>  
             <!-- Chief Complaint -->
          <xsl:when test="(@root = '2.16.840.1.113883.10.20.22.2.12') or (@root = '1.3.6.1.4.1.19376.1.5.3.1.1.13.2.1') or (@root = '2.16.840.1.113883.10.20.22.2.13')">        
                <span class="greentext">
                   Coded values are not inspected for this section
                </span>
             </xsl:when>
          <!-- Admission or Discharge Meds -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.11.1&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.44&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '10183-2' or '42346-7']">                
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:substanceAdministration/n1:consumable/n1:manufacturedProduct/n1:manufacturedMaterial/n1:code">
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.14&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '47420-5']">                
                <xsl:for-each select="n1:entry/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
           ...
           <!-- Encounters -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.22.1&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.22&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '46240-8']">                
                <xsl:for-each select="n1:entry/n1:encounter/n1:entryRelationship/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <!-- Hospital admission/discharge diagnosis -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.24&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.43&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '11535-2' or '46241-6']">                
                <xsl:for-each select="n1:entry/n1:encounter/n1:entryRelationship/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
          ...
          <!-- Post OP/procedure diagnosis -->
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.35&apos;) or (@root = &apos;2.16.840.1.113883.10.20.22.2.36&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '10218-6' or '59769-0']">                
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                ...
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <!-- Plan of care -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.10&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '18776-5']">                
                <xsl:for-each select="n1:entry/n1:observation/n1:code">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                ...
                <xsl:for-each select="n1:entry/n1:procedure/n1:code">                     
                 ...
                 <xsl:for-each select="n1:entry/n1:encounter/n1:code">                     
                      CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                      CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                      Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                      Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <!-- assessment -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.8&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '51848-0']">                
                <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '18776-5']">                
                   <xsl:for-each select="n1:entry/n1:observation/n1:code">                     
                      CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                      CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
          ...
          <!-- assessment/plan) -->
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.9&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '51847-2']">                
                <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '18776-5']">                
                   <xsl:for-each select="n1:entry/n1:observation/n1:code">                     
                      CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                      CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
          ...
          <xsl:when test="(@root = &apos;2.16.840.1.113883.10.20.22.2.22.1&apos;) and (n1:observation/n1:templateid/@root = &apos;2.16.840.1.113883.10.20.22.4.19&apos;)">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '46240-8']">                
                <xsl:for-each select="n1:entry/n1:encounter/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
                   Name: <span class="greentext"> <xsl:value-of select="@displayName"/> </span>                
          ...
          <xsl:when test="@root = &apos;2.16.840.1.113883.10.20.22.2.35&apos;">        
             <xsl:for-each select="/n1:ClinicalDocument/n1:component/n1:structuredBody/n1:component/n1:section[n1:code/@code = '10218-6']">                
                <xsl:for-each select="n1:entry/n1:act/n1:entryRelationship/n1:observation/n1:value">                     
                   CodeSystemName:<span class="greentext"><xsl:value-of select="@codeSystemName"/></span>
                   CodeSystem:<span class="greentext"><xsl:value-of select="@codeSystem"/></span>
                   Code: <span class="greentext"> <xsl:value-of select="@code"/></span>
          ...
          <xsl:otherwise>Section template # is incorrect or is not defined in stylesheet</xsl:otherwise>
     </xsl:choose>     
   </xsl:template>         
...
-->
   ...
   <!-- show-race-code -->
   <xsl:template name="show-race-code">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <span class="redtext">
            <xsl:text>RACE CODE MISSING</xsl:text></span>
         </xsl:otherwise>
      </xsl:choose>
      <br></br>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <span class="redtext">
            <xsl:text>CODE SYSTEM MISSING</xsl:text></span>
         </xsl:otherwise>
      </xsl:choose>
      <br></br>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <span class="redtext">
            <xsl:text>Code Sys Name MISSING</xsl:text></span>
         </xsl:otherwise>
      </xsl:choose>
   </xsl:template>
   <!-- show-contactInfo -->
