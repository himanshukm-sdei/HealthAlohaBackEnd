...
#else
            token = new TokenModel() { UserID = 5, OrganizationID = 1, Timezone = "India Standard Time", IPAddress = "203.129.220.76", LocationID = 1, RoleID = 1, DomainName = HCOrganizationConnectionStringEnum.Host, Request = request, OffSet = 330 };
#endif
            return token;
        }
